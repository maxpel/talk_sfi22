...
Results can be cherry-picked by optimizing the tool (so many available, broad range of quality)
...
Individual person level: Associations sometimes higher (for example for depression: Eichstaedt et al., 2018) and sometimes lower (PANAS scale: Beasley & Mason, 2015) with personality traits
...
Our contribution: *Macroscopic* validation
...
Baseline period from "2020-03-16" to "2020-04-20"

Compare to: Proportion of positive in the survey
...
Pre-registered a study with Twitter data
...
<!-- * move "aside" down a little bit -->

<!-- * copy content from google slides talk (insert graphics directly as svg) -->
